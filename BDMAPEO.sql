...
CREATE TABLE IF NOT EXISTS `TPCuatrimestral`.`Login` (
  ...
  INDEX `fk_Login_Usuario1_idx` (`idUsuario` ASC)  COMMENT '',
  INDEX `fk_Login_Cliente1_idx` (`idCliente` ASC)  COMMENT '',
  CONSTRAINT `fk_Login_Usuario1`
    FOREIGN KEY (`idUsuario`)
    REFERENCES `TPCuatrimestral`.`Usuario` (`idUsuario`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
CREATE TABLE IF NOT EXISTS `TPCuatrimestral`.`TicketLimpieza` (
  ...
  INDEX `fk_TicketLimpieza_Login1_idx` (`usuario` ASC)  COMMENT '',
  ...
  CONSTRAINT `fk_TicketLimpieza_Login1`
    FOREIGN KEY (`usuario`)
    REFERENCES `TPCuatrimestral`.`Login` (`usuario`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `TPCuatrimestral`.`TicketMantenimiento` (
  ...
  INDEX `fk_TicketMantenimiento_Login1_idx` (`usuario` ASC)  COMMENT '',
...
CREATE TABLE IF NOT EXISTS `tpcuatrimestralmapeo`.`usuario` (
  ...
  `baja` TINYINT(1) NULL DEFAULT NULL COMMENT '',
  PRIMARY KEY (`idUsuario`)  COMMENT '')
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
